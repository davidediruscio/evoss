...
$qu = "SELECT ".$_GET['t'].".ID as ID, ".$assoc[0].".".$findfield1['myfield']." as ".$assoc[0].", ".$assoc[1].".".$findfield2['myfield']." as ".$assoc[1]."  FROM ".$_GET['t']." JOIN ".$assoc[0]." ON ".$_GET['t'].".idfirst = ".$assoc[0].".ID JOIN ".$assoc[1]." ON ".$_GET['t'].".idsecond = ".$assoc[1].".ID";
$fulltable = SQL($qu);
