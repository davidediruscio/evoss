...
$edit = SQL('SELECT * FROM '.$_GET['t'].' WHERE ID = "'.$_GET['ID'].'"');
foreach($edit as $k => $fields) {}
...
<form id='editform' name='editform' method='post' action='ass_mod_id.php?t=<?php print $_GET['t']; ?>'>											
...
print "<td><input type='text' style='width: 95.5%;' id='".$campi[$cont]."' name='".$campi[$cont]."' value='".$fields[$campi[$cont]]."' readonly='readonly' maxlength='".$grandezza[$cont]."' /></td>";
$cont++;
}
?>
...
if ($fields['idfirst'] == $firstq['ID']) print "<option selected='selected' value='".$firstq['ID']."' onclick='ass_sign(1,".$firstq['ID'].");'>".$firstq[$findfield1['myfield']]."</option>";
else print "<option value='".$firstq['ID']."' onclick='ass_sign(1,".$firstq['ID'].");'>".$firstq[$findfield1['myfield']]."</option>";
...
if ($fields['idsecond'] == $secondq['ID']) print "<option selected='selected' value='".$secondq['ID']."' onclick='ass_sign(2,".$secondq['ID'].");'>".$secondq[$findfield2['myfield']]."</option>";
else print "<option value='".$secondq['ID']."' onclick='ass_sign(2,".$secondq['ID'].");'>".$secondq[$findfield2['myfield']]."</option>";
...
<input type='image' name='submit' src='images/modifica.png' />
</td></tr>
</table>
