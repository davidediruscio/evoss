 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.AndDepImpl#getOps <em>Ops</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.AndDepImpl#getDependence <em>Dependence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndDepImpl extends DependenceImpl implements AndDep {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.AND_DEP;
	}
	...
	public EList<Dependence> getOps() {
		if (ops == null) {
			ops = new EObjectContainmentEList<Dependence>(Dependence.class, this, MancoosiPackage.AND_DEP__OPS);
		}
		return ops;
	}
	...
	public Dependence getDependence() {
		if (eContainerFeatureID() != MancoosiPackage.AND_DEP__DEPENDENCE) return null;
	...
	public NotificationChain basicSetDependence(Dependence newDependence, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDependence, MancoosiPackage.AND_DEP__DEPENDENCE, msgs);
		return msgs;
	}
	...
	public void setDependence(Dependence newDependence) {
		if (newDependence != eInternalContainer() || (eContainerFeatureID() != MancoosiPackage.AND_DEP__DEPENDENCE && newDependence != null)) {
			...
			if (newDependence != null)
				msgs = ((InternalEObject)newDependence).eInverseAdd(this, MancoosiPackage.DEPENDENCE__AND_DEP, Dependence.class, msgs);
			msgs = basicSetDependence(newDependence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.AND_DEP__DEPENDENCE, newDependence, newDependence));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MancoosiPackage.AND_DEP__DEPENDENCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MancoosiPackage.AND_DEP__OPS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case MancoosiPackage.AND_DEP__DEPENDENCE:
				return eInternalContainer().eInverseRemove(this, MancoosiPackage.DEPENDENCE__AND_DEP, Dependence.class, msgs);
		}
