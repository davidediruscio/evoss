 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.MenuImpl#getEntries <em>Entries</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.MenuImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.MenuImpl#getEnv <em>Env</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MenuImpl extends EObjectImpl implements Menu {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.MENU;
	}
	...
	public EList<MenuEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentWithInverseEList<MenuEntry>(MenuEntry.class, this, MancoosiPackage.MENU__ENTRIES, MancoosiPackage.MENU_ENTRY__MENU);
		}
		return entries;
	}
