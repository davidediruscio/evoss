 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.Group#getEnv <em>Env</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.Group#getUsers <em>Users</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.univaq.mancoosi.mancoosimm.MancoosiPackage#getGroup()
 * @model
 * @generated
 */
public interface Group extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link it.univaq.mancoosi.mancoosimm.Environment#getGroups <em>Groups</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see it.univaq.mancoosi.mancoosimm.MancoosiPackage#getGroup_Env()
	...
	/**
	 * Sets the value of the '{@link it.univaq.mancoosi.mancoosimm.Group#getEnv <em>Env</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link it.univaq.mancoosi.mancoosimm.User#getGroups <em>Groups</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see it.univaq.mancoosi.mancoosimm.MancoosiPackage#getGroup_Users()
	 * @see it.univaq.mancoosi.mancoosimm.User#getGroups
	 * @model opposite="groups" ordered="false"
	 * @generated
	 */
	EList<User> getUsers();
