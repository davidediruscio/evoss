 ...
 * <ul>
 *   <li>{@link mancoosi.impl.PrermInitImpl#getScriptParam <em>Script Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrermInitImpl extends UpdateEnvironmentStatementImpl implements PrermInit {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getPrermInit();
	}
		...
		if (scriptParam != null && scriptParam.eIsProxy()) {
			...
			if (scriptParam != oldScriptParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MancoosiPackage.PRERM_INIT__SCRIPT_PARAM, oldScriptParam, scriptParam));
			}
		}
		return scriptParam;
	}
	...
	public void setScriptParam(File newScriptParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.PRERM_INIT__SCRIPT_PARAM, oldScriptParam, scriptParam));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MancoosiPackage.PRERM_INIT__SCRIPT_PARAM:
