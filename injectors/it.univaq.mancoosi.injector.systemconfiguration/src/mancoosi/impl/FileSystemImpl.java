 ...
 * <ul>
 *   <li>{@link mancoosi.impl.FileSystemImpl#getRoot <em>Root</em>}</li>
 *   <li>{@link mancoosi.impl.FileSystemImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link mancoosi.impl.FileSystemImpl#getAllFiles <em>All Files</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileSystemImpl extends NamedElementImpl implements FileSystem {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getFileSystem();
	}
	 ...
	 * @generated
	 */
	public EList getAllFiles() {
		if (allFiles == null) {
			allFiles = new EObjectResolvingEList(File.class, this, MancoosiPackage.FILE_SYSTEM__ALL_FILES);
		}
		return allFiles;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MancoosiPackage.FILE_SYSTEM__ALL_FILES:
				getAllFiles().clear();
				getAllFiles().addAll((Collection)newValue);
				return;
		}
