 ...
 * <ul>
 *   <li>{@link mancoosi.impl.ConflictImpl#getAndConflict <em>And Conflict</em>}</li>
 *   <li>{@link mancoosi.impl.ConflictImpl#getOrConflict <em>Or Conflict</em>}</li>
 *   <li>{@link mancoosi.impl.ConflictImpl#getSingleConflict <em>Single Conflict</em>}</li>
 *   <li>{@link mancoosi.impl.ConflictImpl#getPkg <em>Pkg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConflictImpl extends EObjectImpl implements Conflict {
	 ...
	 * @ordered
	 */
	protected mancoosi.Package pkg;
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getConflict();
	}
	...
	public mancoosi.Package getPkg() {
		if (pkg != null && pkg.eIsProxy()) {
			...
			pkg = (mancoosi.Package)eResolveProxy(oldPkg);
			if (pkg != oldPkg) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public mancoosi.Package basicGetPkg() {
		return pkg;
	}
