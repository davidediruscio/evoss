...
public class PackageModelManager {
	 ...
	 */
	public PackageModelManager(String packageNameInput) throws Exception {
	...
	private Package loadModelPackage() throws Exception {
		...
		java.io.File modelPackageFile = new java.io.File(config.getDirInputPackageModels()
		...
		if (!modelPackageFile.exists())
				throw new PackageModelFileNotFoundException("Model Package '"
						+ this.packageNameInput + "."
						+ config.getFileExtensionPackageModel() + "' not found!");
	...
	public String saveModel() throws Exception {
		try {
			String inputPackageModel = config.getDirInputPackageModels()
									+ this.packageNameInput + "."
									+ config.getFileExtensionPackageModel();
