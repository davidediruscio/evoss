 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.AndConflict#getOps <em>Ops</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.AndConflict#getConflict <em>Conflict</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getAndConflict()
 * @model
 * @generated
 */
public interface AndConflict extends Conflict {
	 ...
	 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getAndConflict_Ops()
	 ...
	 * It is bidirectional and its opposite is '{@link it.univaq.mancoosi.packagemm.Conflict#getAndConflict <em>And Conflict</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getAndConflict_Conflict()
	...
	/**
	 * Sets the value of the '{@link it.univaq.mancoosi.packagemm.AndConflict#getConflict <em>Conflict</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
