 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.ConditionImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConditionImpl extends EObjectImpl implements Condition {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getCondition();
	}
	...
	public EList<Statement> getAction() {
		if (action == null) {
			action = new EObjectContainmentEList<Statement>(Statement.class, this, PackagemmPackage.CONDITION__ACTION);
		}
		return action;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.CONDITION__ACTION:
