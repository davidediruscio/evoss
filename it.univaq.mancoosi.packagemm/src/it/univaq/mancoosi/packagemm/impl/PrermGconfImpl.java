 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PrermGconfImpl#getSchemas <em>Schemas</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrermGconfImpl extends UpdatePackageSettingStatementImpl implements PrermGconf {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getPrermGconf();
	}
	...
	public EList<File> getSchemas() {
		if (schemas == null) {
			schemas = new EObjectContainmentEList<File>(File.class, this, PackagemmPackage.PRERM_GCONF__SCHEMAS);
		}
		return schemas;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.PRERM_GCONF__SCHEMAS:
