...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>String Greater Boolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringGreaterBooleanImpl#getFirstOp <em>First Op</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringGreaterBooleanImpl#getSecondOp <em>Second Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringGreaterBooleanImpl extends BooleanExpressionImpl implements StringGreaterBoolean {
	/**
	 ...
	 * @generated
	 */
	protected StringGreaterBooleanImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getStringGreaterBoolean();
	}
	...
	public void setFirstOp(String newFirstOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_GREATER_BOOLEAN__FIRST_OP, oldFirstOp, firstOp));
	}
	...
	public void setSecondOp(String newSecondOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_GREATER_BOOLEAN__SECOND_OP, oldSecondOp, secondOp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.STRING_GREATER_BOOLEAN__FIRST_OP:
				return getFirstOp();
			case PackagemmPackage.STRING_GREATER_BOOLEAN__SECOND_OP:
				return getSecondOp();
		}
