 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PostinstMenuMethodImpl#getPackage <em>Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostinstMenuMethodImpl extends UpdateEnvironmentStatementImpl implements PostinstMenuMethod {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getPostinstMenuMethod();
	}
	...
	public NotificationChain basicSetPackage(it.univaq.mancoosi.packagemm.Package newPackage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_MENU_METHOD__PACKAGE, oldPackage, newPackage);
	...
	public void setPackage(it.univaq.mancoosi.packagemm.Package newPackage) {
		if (newPackage != package_) {
			...
			if (package_ != null)
				msgs = ((InternalEObject)package_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_MENU_METHOD__PACKAGE, null, msgs);
			if (newPackage != null)
				msgs = ((InternalEObject)newPackage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_MENU_METHOD__PACKAGE, null, msgs);
			msgs = basicSetPackage(newPackage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_MENU_METHOD__PACKAGE, newPackage, newPackage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.POSTINST_MENU_METHOD__PACKAGE:
