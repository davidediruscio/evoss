...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>String Equal Boolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringEqualBooleanImpl#getFirstOp <em>First Op</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringEqualBooleanImpl#getSecondOp <em>Second Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringEqualBooleanImpl extends BooleanExpressionImpl implements StringEqualBoolean {
	/**
	 ...
	 * @generated
	 */
	protected StringEqualBooleanImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getStringEqualBoolean();
	}
	...
	public void setFirstOp(String newFirstOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_EQUAL_BOOLEAN__FIRST_OP, oldFirstOp, firstOp));
	}
	...
	public void setSecondOp(String newSecondOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_EQUAL_BOOLEAN__SECOND_OP, oldSecondOp, secondOp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.STRING_EQUAL_BOOLEAN__FIRST_OP:
				return getFirstOp();
			case PackagemmPackage.STRING_EQUAL_BOOLEAN__SECOND_OP:
				return getSecondOp();
		}
