...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>String Less Boolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringLessBooleanImpl#getFirstOp <em>First Op</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.StringLessBooleanImpl#getSecondOp <em>Second Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StringLessBooleanImpl extends BooleanExpressionImpl implements StringLessBoolean {
	/**
	 ...
	 * @generated
	 */
	protected StringLessBooleanImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getStringLessBoolean();
	}
	...
	public void setFirstOp(String newFirstOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_LESS_BOOLEAN__FIRST_OP, oldFirstOp, firstOp));
	}
	...
	public void setSecondOp(String newSecondOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.STRING_LESS_BOOLEAN__SECOND_OP, oldSecondOp, secondOp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.STRING_LESS_BOOLEAN__FIRST_OP:
				return getFirstOp();
			case PackagemmPackage.STRING_LESS_BOOLEAN__SECOND_OP:
				return getSecondOp();
		}
