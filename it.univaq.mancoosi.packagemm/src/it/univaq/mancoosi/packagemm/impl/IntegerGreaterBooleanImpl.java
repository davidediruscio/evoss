...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Integer Greater Boolean</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.IntegerGreaterBooleanImpl#getFirstOp <em>First Op</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.IntegerGreaterBooleanImpl#getSecondOp <em>Second Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntegerGreaterBooleanImpl extends BooleanExpressionImpl implements IntegerGreaterBoolean {
	/**
	 ...
	 * @generated
	 */
	protected IntegerGreaterBooleanImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getIntegerGreaterBoolean();
	}
	...
	public void setFirstOp(int newFirstOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.INTEGER_GREATER_BOOLEAN__FIRST_OP, oldFirstOp, firstOp));
	}
	...
	public void setSecondOp(int newSecondOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.INTEGER_GREATER_BOOLEAN__SECOND_OP, oldSecondOp, secondOp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.INTEGER_GREATER_BOOLEAN__FIRST_OP:
				return getFirstOp();
			case PackagemmPackage.INTEGER_GREATER_BOOLEAN__SECOND_OP:
				return getSecondOp();
		}
