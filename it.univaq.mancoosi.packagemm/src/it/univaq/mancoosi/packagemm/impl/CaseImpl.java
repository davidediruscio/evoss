 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.CaseImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.CaseImpl#getDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CaseImpl extends ControlStatementImpl implements Case {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getCase();
	}
	...
	public void setSelector(String newSelector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.CASE__SELECTOR, oldSelector, selector));
	}
	...
	public NotificationChain basicSetDefault(DefaultCaseCondition newDefault, NotificationChain msgs) {
		...
		default_ = newDefault;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PackagemmPackage.CASE__DEFAULT, oldDefault, newDefault);
	...
	public void setDefault(DefaultCaseCondition newDefault) {
		if (newDefault != default_) {
			...
			if (default_ != null)
				msgs = ((InternalEObject)default_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.CASE__DEFAULT, null, msgs);
			if (newDefault != null)
				msgs = ((InternalEObject)newDefault).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.CASE__DEFAULT, null, msgs);
			msgs = basicSetDefault(newDefault, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.CASE__DEFAULT, newDefault, newDefault));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.CASE__DEFAULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.CASE__SELECTOR:
				return getSelector();
			case PackagemmPackage.CASE__DEFAULT:
				return getDefault();
		}
