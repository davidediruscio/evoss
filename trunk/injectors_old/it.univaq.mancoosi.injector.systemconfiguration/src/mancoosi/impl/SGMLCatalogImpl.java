 ...
 * <ul>
 *   <li>{@link mancoosi.impl.SGMLCatalogImpl#getEnv <em>Env</em>}</li>
 *   <li>{@link mancoosi.impl.SGMLCatalogImpl#getDocuments <em>Documents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SGMLCatalogImpl extends NamedElementImpl implements SGMLCatalog {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getSGMLCatalog();
	}
	...
	public EList getDocuments() {
		if (documents == null) {
			documents = new EObjectResolvingEList(SGMLDocument.class, this, MancoosiPackage.SGML_CATALOG__DOCUMENTS);
		}
		return documents;
	}
