 ...
 * <ul>
 *   <li>{@link mancoosi.impl.MimeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link mancoosi.impl.MimeTypeImpl#getExtension <em>Extension</em>}</li>
 *   <li>{@link mancoosi.impl.MimeTypeImpl#getMimeTypeHandlers <em>Mime Type Handlers</em>}</li>
 *   <li>{@link mancoosi.impl.MimeTypeImpl#getCache <em>Cache</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MimeTypeImpl extends EObjectImpl implements MimeType {
	 ...
	 * @ordered
	 */
	protected EList mimeTypeHandlers;
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getMimeType();
	}
	 ...
	 * @generated
	 */
	public EList getMimeTypeHandlers() {
		if (mimeTypeHandlers == null) {
			mimeTypeHandlers = new EObjectWithInverseResolvingEList(MimeTypeHandler.class, this, MancoosiPackage.MIME_TYPE__MIME_TYPE_HANDLERS, MancoosiPackage.MIME_TYPE_HANDLER__TYPE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MancoosiPackage.MIME_TYPE__MIME_TYPE_HANDLERS:
				return ((InternalEList)getMimeTypeHandlers()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MancoosiPackage.MIME_TYPE__MIME_TYPE_HANDLERS:
				...
				getMimeTypeHandlers().addAll((Collection)newValue);
				return;
			case MancoosiPackage.MIME_TYPE__CACHE:
