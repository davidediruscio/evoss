 ...
 * <ul>
 *   <li>{@link mancoosi.impl.PostinstInitNostartImpl#getScriptParam <em>Script Param</em>}</li>
 *   <li>{@link mancoosi.impl.PostinstInitNostartImpl#getInitParams <em>Init Params</em>}</li>
 *   <li>{@link mancoosi.impl.PostinstInitNostartImpl#getErrorHandler <em>Error Handler</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostinstInitNostartImpl extends UpdateEnvironmentStatementImpl implements PostinstInitNostart {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getPostinstInitNostart();
	}
		...
		if (scriptParam != null && scriptParam.eIsProxy()) {
			...
			if (scriptParam != oldScriptParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MancoosiPackage.POSTINST_INIT_NOSTART__SCRIPT_PARAM, oldScriptParam, scriptParam));
			}
		}
		return scriptParam;
	}
	...
	public void setScriptParam(Script newScriptParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.POSTINST_INIT_NOSTART__SCRIPT_PARAM, oldScriptParam, scriptParam));
	}
	...
	public EList getInitParams() {
		if (initParams == null) {
			initParams = new EObjectResolvingEList(Param.class, this, MancoosiPackage.POSTINST_INIT_NOSTART__INIT_PARAMS);
		}
		return initParams;
	}
	...
	public File getErrorHandler() {
		if (errorHandler != null && errorHandler.eIsProxy()) {
			...
			if (errorHandler != oldErrorHandler) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MancoosiPackage.POSTINST_INIT_NOSTART__ERROR_HANDLER, oldErrorHandler, errorHandler));
			}
		}
		return errorHandler;
	}
	...
	public void setErrorHandler(File newErrorHandler) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.POSTINST_INIT_NOSTART__ERROR_HANDLER, oldErrorHandler, errorHandler));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MancoosiPackage.POSTINST_INIT_NOSTART__SCRIPT_PARAM:
				if (resolve) return getScriptParam();
				return basicGetScriptParam();
			case MancoosiPackage.POSTINST_INIT_NOSTART__INIT_PARAMS:
				return getInitParams();
			case MancoosiPackage.POSTINST_INIT_NOSTART__ERROR_HANDLER:
