 ...
 * <ul>
 *   <li>{@link mancoosi.impl.OrDepImpl#getOps <em>Ops</em>}</li>
 *   <li>{@link mancoosi.impl.OrDepImpl#getDependence <em>Dependence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrDepImpl extends DependenceImpl implements OrDep {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getOrDep();
	}
	...
	public EList getOps() {
		if (ops == null) {
			ops = new EObjectContainmentEList(Dependence.class, this, MancoosiPackage.OR_DEP__OPS);
		}
		return ops;
	}
