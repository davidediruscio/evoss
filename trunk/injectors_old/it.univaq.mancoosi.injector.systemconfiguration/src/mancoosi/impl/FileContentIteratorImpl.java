 ...
 * <ul>
 *   <li>{@link mancoosi.impl.FileContentIteratorImpl#getFile <em>File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileContentIteratorImpl extends IteratorImpl implements FileContentIterator {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getFileContentIterator();
	}
		...
		if (file != null && file.eIsProxy()) {
			...
			if (file != oldFile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MancoosiPackage.FILE_CONTENT_ITERATOR__FILE, oldFile, file));
			}
		}
		return file;
	}
	...
	public void setFile(File newFile) {
		...
		file = newFile;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.FILE_CONTENT_ITERATOR__FILE, oldFile, file));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MancoosiPackage.FILE_CONTENT_ITERATOR__FILE:
