 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PostrmXfontsImpl#getCmds <em>Cmds</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostrmXfontsImpl extends UpdateEnvironmentStatementImpl implements PostrmXfonts {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getPostrmXfonts();
	}
	...
	public EList<Statement> getCmds() {
		if (cmds == null) {
			cmds = new EObjectContainmentEList<Statement>(Statement.class, this, PackagemmPackage.POSTRM_XFONTS__CMDS);
		}
		return cmds;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.POSTRM_XFONTS__CMDS:
