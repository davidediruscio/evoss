 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PreinstScriptImpl#getPkg <em>Pkg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PreinstScriptImpl extends ScriptImpl implements PreinstScript {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getPreinstScript();
	}
	...
	public it.univaq.mancoosi.packagemm.Package getPkg() {
		if (eContainerFeatureID() != PackagemmPackage.PREINST_SCRIPT__PKG) return null;
	...
	public NotificationChain basicSetPkg(it.univaq.mancoosi.packagemm.Package newPkg, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPkg, PackagemmPackage.PREINST_SCRIPT__PKG, msgs);
		return msgs;
	}
	...
	public void setPkg(it.univaq.mancoosi.packagemm.Package newPkg) {
		if (newPkg != eInternalContainer() || (eContainerFeatureID() != PackagemmPackage.PREINST_SCRIPT__PKG && newPkg != null)) {
			...
			if (newPkg != null)
				msgs = ((InternalEObject)newPkg).eInverseAdd(this, PackagemmPackage.PACKAGE__PREINST_SCRIPT, it.univaq.mancoosi.packagemm.Package.class, msgs);
			msgs = basicSetPkg(newPkg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.PREINST_SCRIPT__PKG, newPkg, newPkg));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.PREINST_SCRIPT__PKG:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PackagemmPackage.PREINST_SCRIPT__PKG:
				return eInternalContainer().eInverseRemove(this, PackagemmPackage.PACKAGE__PREINST_SCRIPT, it.univaq.mancoosi.packagemm.Package.class, msgs);
		}
