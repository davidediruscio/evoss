 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.EnvironmentStatementImpl#getEnvironment <em>Environment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EnvironmentStatementImpl extends StatementImpl implements EnvironmentStatement {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getEnvironmentStatement();
	}
	...
	public void setEnvironment(String newEnvironment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.ENVIRONMENT_STATEMENT__ENVIRONMENT, oldEnvironment, environment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PackagemmPackage.ENVIRONMENT_STATEMENT__ENVIRONMENT:
