 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PostinstInitImpl#getScriptParam <em>Script Param</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PostinstInitImpl#getInitParams <em>Init Params</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.PostinstInitImpl#getErrorHandler <em>Error Handler</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PostinstInitImpl extends UpdateEnvironmentStatementImpl implements PostinstInit {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getPostinstInit();
	}
	...
	public NotificationChain basicSetScriptParam(Script newScriptParam, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_INIT__SCRIPT_PARAM, oldScriptParam, newScriptParam);
	...
	public void setScriptParam(Script newScriptParam) {
		if (newScriptParam != scriptParam) {
			...
			if (scriptParam != null)
				msgs = ((InternalEObject)scriptParam).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_INIT__SCRIPT_PARAM, null, msgs);
			if (newScriptParam != null)
				msgs = ((InternalEObject)newScriptParam).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_INIT__SCRIPT_PARAM, null, msgs);
			msgs = basicSetScriptParam(newScriptParam, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_INIT__SCRIPT_PARAM, newScriptParam, newScriptParam));
	}
	...
	public EList<Param> getInitParams() {
		if (initParams == null) {
			initParams = new EObjectContainmentEList<Param>(Param.class, this, PackagemmPackage.POSTINST_INIT__INIT_PARAMS);
		}
		return initParams;
	}
	...
	public NotificationChain basicSetErrorHandler(Statement newErrorHandler, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_INIT__ERROR_HANDLER, oldErrorHandler, newErrorHandler);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setErrorHandler(Statement newErrorHandler) {
		if (newErrorHandler != errorHandler) {
			...
			if (errorHandler != null)
				msgs = ((InternalEObject)errorHandler).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_INIT__ERROR_HANDLER, null, msgs);
			if (newErrorHandler != null)
				msgs = ((InternalEObject)newErrorHandler).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PackagemmPackage.POSTINST_INIT__ERROR_HANDLER, null, msgs);
			msgs = basicSetErrorHandler(newErrorHandler, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.POSTINST_INIT__ERROR_HANDLER, newErrorHandler, newErrorHandler));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.POSTINST_INIT__SCRIPT_PARAM:
				return basicSetScriptParam(null, msgs);
			case PackagemmPackage.POSTINST_INIT__INIT_PARAMS:
				return ((InternalEList<?>)getInitParams()).basicRemove(otherEnd, msgs);
			case PackagemmPackage.POSTINST_INIT__ERROR_HANDLER:
