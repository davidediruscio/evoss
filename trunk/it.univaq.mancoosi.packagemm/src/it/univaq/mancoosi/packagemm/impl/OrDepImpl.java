 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.OrDepImpl#getOps <em>Ops</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.impl.OrDepImpl#getDependence <em>Dependence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrDepImpl extends DependenceImpl implements OrDep {
	...
	protected EClass eStaticClass() {
		return PackagemmPackage.eINSTANCE.getOrDep();
	}
	...
	public EList<Dependence> getOps() {
		if (ops == null) {
			ops = new EObjectContainmentEList<Dependence>(Dependence.class, this, PackagemmPackage.OR_DEP__OPS);
		}
		return ops;
	}
	...
	public Dependence getDependence() {
		if (eContainerFeatureID() != PackagemmPackage.OR_DEP__DEPENDENCE) return null;
	...
	public NotificationChain basicSetDependence(Dependence newDependence, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDependence, PackagemmPackage.OR_DEP__DEPENDENCE, msgs);
		return msgs;
	}
	...
	public void setDependence(Dependence newDependence) {
		if (newDependence != eInternalContainer() || (eContainerFeatureID() != PackagemmPackage.OR_DEP__DEPENDENCE && newDependence != null)) {
			...
			if (newDependence != null)
				msgs = ((InternalEObject)newDependence).eInverseAdd(this, PackagemmPackage.DEPENDENCE__OR_DEP, Dependence.class, msgs);
			msgs = basicSetDependence(newDependence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PackagemmPackage.OR_DEP__DEPENDENCE, newDependence, newDependence));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.OR_DEP__DEPENDENCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PackagemmPackage.OR_DEP__OPS:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case PackagemmPackage.OR_DEP__DEPENDENCE:
				return eInternalContainer().eInverseRemove(this, PackagemmPackage.DEPENDENCE__OR_DEP, Dependence.class, msgs);
		}
