 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.packagemm.PostrmInit#getScriptParam <em>Script Param</em>}</li>
 *   <li>{@link it.univaq.mancoosi.packagemm.PostrmInit#getErrorHandler <em>Error Handler</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getPostrmInit()
 * @model
 * @generated
 */
public interface PostrmInit extends UpdateEnvironmentStatement, DeletionFileSystemStatement {
	 ...
	 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getPostrmInit_ScriptParam()
	...
	/**
	 * Sets the value of the '{@link it.univaq.mancoosi.packagemm.PostrmInit#getScriptParam <em>Script Param</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getPostrmInit_ErrorHandler()
	 * @model containment="true" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.univaq.mancoosi.packagemm.PostrmInit#getErrorHandler <em>Error Handler</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
