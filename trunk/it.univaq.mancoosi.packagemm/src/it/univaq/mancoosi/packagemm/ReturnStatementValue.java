 ...
 * <!-- end-user-doc -->
 * @see it.univaq.mancoosi.packagemm.PackagemmPackage#getReturnStatementValue()
 * @model
 * @generated
 */
public enum ReturnStatementValue implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	public static final List<ReturnStatementValue> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
