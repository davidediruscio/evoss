 ...
 * <ul>
 *   <li>{@link mancoosi.impl.ModuleCacheImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link mancoosi.impl.ModuleCacheImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link mancoosi.impl.ModuleCacheImpl#getEnv <em>Env</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModuleCacheImpl extends EObjectImpl implements ModuleCache {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.eINSTANCE.getModuleCache();
	}
	...
	public EList getModules() {
		if (modules == null) {
			modules = new EObjectContainmentWithInverseEList(Module.class, this, MancoosiPackage.MODULE_CACHE__MODULES, MancoosiPackage.MODULE__MODULE_CACHE);
		}
		return modules;
	}
