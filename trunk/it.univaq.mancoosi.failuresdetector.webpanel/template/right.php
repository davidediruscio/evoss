...
/* show tables */
$qu = "SHOW TABLES where tables_in_faultdetector  not like 'ass_%' AND tables_in_faultdetector not like 'conf_%' AND tables_in_faultdetector  not like 'keywords'";
...
/* show tables */
$qu = "SHOW TABLES where tables_in_faultdetector like 'ass_%' AND tables_in_faultdetector not like '%keywords%'";
...
/* show tables */
$qu = "SHOW TABLES where tables_in_faultdetector like 'conf_%'";
$result = mysql_query($qu,$connection) or die('cannot show tables');
while($tableName = mysql_fetch_row($result)) {
