...
public class MancoosiAdapterFactory extends AdapterFactoryImpl {
	...
	protected MancoosiSwitch<Adapter> modelSwitch =
		new MancoosiSwitch<Adapter>() {
			...
			@Override
			public Adapter caseConfigFilesPackage(ConfigFilesPackage object) {
				return createConfigFilesPackageAdapter();
			}
			@Override
			public Adapter caseUnpackedPackage(UnpackedPackage object) {
				return createUnpackedPackageAdapter();
			}
			@Override
			public Adapter caseHalfConfiguredPackage(HalfConfiguredPackage object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.mancoosi.mancoosimm.ConfigFilesPackage <em>Config Files Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfigFilesPackageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.mancoosi.mancoosimm.UnpackedPackage <em>Unpacked Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUnpackedPackageAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link it.univaq.mancoosi.mancoosimm.HalfConfiguredPackage <em>Half Configured Package</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createHalfConfiguredPackageAdapter() {
		return null;
	}
