...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Config Files Package</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getMaintainer <em>Maintainer</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getCheckSum <em>Check Sum</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getSection <em>Section</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getTag <em>Tag</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.ConfigFilesPackageImpl#getUploaders <em>Uploaders</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConfigFilesPackageImpl extends PackageImpl implements ConfigFilesPackage {
	/**
	 ...
	 * @generated
	 */
	protected ConfigFilesPackageImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.CONFIG_FILES_PACKAGE;
	}
	...
	public void setMaintainer(String newMaintainer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__MAINTAINER, oldMaintainer, maintainer));
	}
	...
	public void setCheckSum(String newCheckSum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__CHECK_SUM, oldCheckSum, checkSum));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setSection(String newSection) {
		...
		section = newSection;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__SECTION, oldSection, section));
	}
	...
	public void setTag(String newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__TAG, oldTag, tag));
	}
	...
	public void setPriority(PriorityType newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__PRIORITY, oldPriority, priority));
	}
	...
	public void setUploaders(String newUploaders) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MancoosiPackage.CONFIG_FILES_PACKAGE__UPLOADERS, oldUploaders, uploaders));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MancoosiPackage.CONFIG_FILES_PACKAGE__MAINTAINER:
				return getMaintainer();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__CHECK_SUM:
				return getCheckSum();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__DESCRIPTION:
				return getDescription();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__SECTION:
				return getSection();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__TAG:
				return getTag();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__PRIORITY:
				return getPriority();
			case MancoosiPackage.CONFIG_FILES_PACKAGE__UPLOADERS:
				return getUploaders();
		}
