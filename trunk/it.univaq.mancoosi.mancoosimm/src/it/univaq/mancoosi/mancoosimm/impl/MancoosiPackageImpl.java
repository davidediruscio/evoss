...
public class MancoosiPackageImpl extends EPackageImpl implements MancoosiPackage {
	...
	public EAttribute getInstalledPackage_Status() {
		return (EAttribute)installedPackageEClass.getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getInstalledPackage_Uploaders() {
		return (EAttribute)installedPackageEClass.getEStructuralFeatures().get(10);
	}
	...
	public EReference getInstalledPackage_DocumentationFiles() {
		return (EReference)installedPackageEClass.getEStructuralFeatures().get(20);
	}
	...
	public EReference getInstalledPackage_Conflict() {
		return (EReference)installedPackageEClass.getEStructuralFeatures().get(21);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(installedPackageEClass, INSTALLED_PACKAGE__ARCHITECTURE);
		...
		createEAttribute(installedPackageEClass, INSTALLED_PACKAGE__STATUS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInstalledPackage_Architecture(), ecorePackage.getEString(), "architecture", null, 1, 1, InstalledPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getInstalledPackage_Status(), this.getStatusType(), "status", null, 1, 1, InstalledPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getPackage_PackageSettings(), this.getPackageSetting(), this.getPackageSetting_Pkg(), "packageSettings", null, 1, 1, it.univaq.mancoosi.mancoosimm.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
