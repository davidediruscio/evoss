 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getRunningServices <em>Running Services</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getAlternatives <em>Alternatives</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getUsers <em>Users</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getEmacspkg <em>Emacspkg</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getIconCache <em>Icon Cache</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getDesktopDb <em>Desktop Db</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getMimeTypeHandlerCache <em>Mime Type Handler Cache</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getLibraryCache <em>Library Cache</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getSkeeperCatalog <em>Skeeper Catalog</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getSgmlCatalog <em>Sgml Catalog</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getModuleCache <em>Module Cache</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getXfontCaches <em>Xfont Caches</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getGconf <em>Gconf</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.EnvironmentImpl#getMenu <em>Menu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnvironmentImpl extends NamedElementImpl implements Environment {
	 ...
	 * @ordered
	 */
	protected EList<Service> runningServices;
	 ...
	 * @ordered
	 */
	protected EList<ModuleCache> moduleCache;
	 ...
	 * @ordered
	 */
	protected EList<XFontCache> xfontCaches;
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.ENVIRONMENT;
	}
	 ...
	 * @generated
	 */
	public EList<Service> getRunningServices() {
		if (runningServices == null) {
			runningServices = new EObjectWithInverseResolvingEList<Service>(Service.class, this, MancoosiPackage.ENVIRONMENT__RUNNING_SERVICES, MancoosiPackage.SERVICE__ENV);
		}
	...
	public EList<Alternative> getAlternatives() {
		if (alternatives == null) {
			alternatives = new EObjectContainmentWithInverseEList<Alternative>(Alternative.class, this, MancoosiPackage.ENVIRONMENT__ALTERNATIVES, MancoosiPackage.ALTERNATIVE__ENV);
		}
		return alternatives;
	}
	...
	public EList<User> getUsers() {
		if (users == null) {
			users = new EObjectContainmentWithInverseEList<User>(User.class, this, MancoosiPackage.ENVIRONMENT__USERS, MancoosiPackage.USER__ENV);
		}
		return users;
	}
	...
	public EList<Group> getGroups() {
		if (groups == null) {
			groups = new EObjectContainmentWithInverseEList<Group>(Group.class, this, MancoosiPackage.ENVIRONMENT__GROUPS, MancoosiPackage.GROUP__ENV);
		}
		return groups;
	}
	 ...
	 * @generated
	 */
	public EList<ModuleCache> getModuleCache() {
		if (moduleCache == null) {
			moduleCache = new EObjectContainmentWithInverseEList<ModuleCache>(ModuleCache.class, this, MancoosiPackage.ENVIRONMENT__MODULE_CACHE, MancoosiPackage.MODULE_CACHE__ENV);
		}
		return moduleCache;
	}
	 ...
	 * @generated
	 */
	public EList<XFontCache> getXfontCaches() {
		if (xfontCaches == null) {
			xfontCaches = new EObjectContainmentWithInverseEList<XFontCache>(XFontCache.class, this, MancoosiPackage.ENVIRONMENT__XFONT_CACHES, MancoosiPackage.XFONT_CACHE__ENV);
		}
		return xfontCaches;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MancoosiPackage.ENVIRONMENT__RUNNING_SERVICES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRunningServices()).basicAdd(otherEnd, msgs);
			...
			case MancoosiPackage.ENVIRONMENT__MODULE_CACHE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getModuleCache()).basicAdd(otherEnd, msgs);
			case MancoosiPackage.ENVIRONMENT__XFONT_CACHES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getXfontCaches()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MancoosiPackage.ENVIRONMENT__RUNNING_SERVICES:
				...
				getRunningServices().addAll((Collection<? extends Service>)newValue);
				return;
			case MancoosiPackage.ENVIRONMENT__ALTERNATIVES:
			...
			case MancoosiPackage.ENVIRONMENT__MODULE_CACHE:
				...
				getModuleCache().addAll((Collection<? extends ModuleCache>)newValue);
				return;
			case MancoosiPackage.ENVIRONMENT__XFONT_CACHES:
				getXfontCaches().clear();
				getXfontCaches().addAll((Collection<? extends XFontCache>)newValue);
				return;
			case MancoosiPackage.ENVIRONMENT__GCONF:
