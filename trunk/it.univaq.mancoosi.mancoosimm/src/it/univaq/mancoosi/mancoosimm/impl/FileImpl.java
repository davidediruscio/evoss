 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getExtension <em>Extension</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getSize <em>Size</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getCheckSum <em>Check Sum</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#isIsDirectory <em>Is Directory</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#isSuid <em>Suid</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#isGuid <em>Guid</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getPermission <em>Permission</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getFs <em>Fs</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getChilds <em>Childs</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#isIsMissing <em>Is Missing</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.FileImpl#getPkgSettings <em>Pkg Settings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileImpl extends NamedElementImpl implements File {
	 ...
	 * @ordered
	 */
	protected EList<PackageSetting> pkgSettings;
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.FILE;
	}
	...
	public EList<File> getChilds() {
		if (childs == null) {
			childs = new EObjectContainmentWithInverseEList<File>(File.class, this, MancoosiPackage.FILE__CHILDS, MancoosiPackage.FILE__PARENT);
		}
		return childs;
	}
	 ...
	 * @generated
	 */
	public EList<PackageSetting> getPkgSettings() {
		if (pkgSettings == null) {
			pkgSettings = new EObjectWithInverseResolvingEList.ManyInverse<PackageSetting>(PackageSetting.class, this, MancoosiPackage.FILE__PKG_SETTINGS, MancoosiPackage.PACKAGE_SETTING__FILES);
		}
		return pkgSettings;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case MancoosiPackage.FILE__PKG_SETTINGS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPkgSettings()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MancoosiPackage.FILE__PKG_SETTINGS:
				...
				getPkgSettings().addAll((Collection<? extends PackageSetting>)newValue);
				return;
		}
