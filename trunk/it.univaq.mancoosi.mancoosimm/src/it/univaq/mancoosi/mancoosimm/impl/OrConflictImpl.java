 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.OrConflictImpl#getOps <em>Ops</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.OrConflictImpl#getConflict <em>Conflict</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrConflictImpl extends ConflictImpl implements OrConflict {
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.OR_CONFLICT;
	}
	...
	public EList<Conflict> getOps() {
		if (ops == null) {
			ops = new EObjectContainmentEList<Conflict>(Conflict.class, this, MancoosiPackage.OR_CONFLICT__OPS);
		}
		return ops;
	}
