 ...
 * <ul>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.SkeeperCatalogImpl#getEnv <em>Env</em>}</li>
 *   <li>{@link it.univaq.mancoosi.mancoosimm.impl.SkeeperCatalogImpl#getDocuments <em>Documents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SkeeperCatalogImpl extends NamedElementImpl implements SkeeperCatalog {
	 ...
	 * @ordered
	 */
	protected EList<SkeeperDocument> documents;
	...
	protected EClass eStaticClass() {
		return MancoosiPackage.Literals.SKEEPER_CATALOG;
	}
	 ...
	 * @generated
	 */
	public EList<SkeeperDocument> getDocuments() {
		if (documents == null) {
			documents = new EObjectResolvingEList<SkeeperDocument>(SkeeperDocument.class, this, MancoosiPackage.SKEEPER_CATALOG__DOCUMENTS);
		}
		return documents;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MancoosiPackage.SKEEPER_CATALOG__DOCUMENTS:
				getDocuments().clear();
				getDocuments().addAll((Collection<? extends SkeeperDocument>)newValue);
				return;
		}
